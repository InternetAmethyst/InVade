...
from Speedo.sql.welcome_sql import get_current_welcome, add_welcome, rm_welcome, update_welcome
from . import *
...
@bot.on(Speedo_cmd(pattern="savewelcome(?: |$)(.*)"))
...
@bot.on(Speedo_cmd(pattern="cleanwelcome$"))
...
@bot.on(Speedo_cmd(pattern="showwelcome$"))
...
@bot.on(Speedo_cmd(pattern="welcome_note$"))
