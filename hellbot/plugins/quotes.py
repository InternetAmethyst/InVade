...
@bot.on(Speedo_cmd(pattern=f"love$", outgoing=True))
...
@bot.on(Speedo_cmd(pattern=f"dhoka$", outgoing=True))
...
@bot.on(Speedo_cmd(pattern=f"metoo$", outgoing=True))
...
@bot.on(Speedo_cmd(pattern=f"gdnoon$", outgoing=True))
...
@bot.on(Speedo_cmd(pattern=f"chase$", outgoing=True))
@bot.on(sudo_cmd(pattern=f"chase$", allow_sudo=True))
async def police(e):
    txt = random.choice(CHASE_STR)
    await eor(e, txt)

@bot.on(Speedo_cmd(pattern=f"congo$", outgoing=True))
...
@bot.on(Speedo_cmd(pattern=f"gdnyt$", outgoing=True))
...
@bot.on(Speedo_cmd(pattern=f"gdmng$", outgoing=True))
...
@bot.on(Speedo_cmd(pattern="quote ?(.*)", outgoing=True))
